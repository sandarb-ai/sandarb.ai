      ...
      <div className="max-w-3xl mx-auto px-6 py-8">
        ...
        <nav className="mb-8 pb-6 border-b border-border">
          ...
          <ul className="text-sm text-muted-foreground space-y-1">
            ...
            <li><a href="#rest-api" className="hover:text-foreground">REST API</a></li>
            <li><a href="#inject" className="hover:text-foreground">Inject API</a></li>
            <li><a href="#a2a" className="hover:text-foreground">A2A protocol</a></li>
            <li><a href="#contexts-agents" className="hover:text-foreground">Contexts & agents</a></li>
            <li><a href="#audit-headers" className="hover:text-foreground">Audit headers</a></li>
            <li><a href="#environment" className="hover:text-foreground">Environment variables</a></li>
            <li><a href="#deployment" className="hover:text-foreground">Deployment</a></li>
          </ul>
        </nav>
