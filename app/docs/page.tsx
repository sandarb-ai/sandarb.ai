...
export default async function DocsPage() {
  ...
  const tocGroups = [
    ...
    },
    {
      ...
      icon: 'Puzzle',
      items: [
        { id: 'unified-sdk-interface', label: 'Unified SDK interface', icon: 'Layers' },
        { id: 'sdks-python-node-go', label: 'SDKs', icon: 'Code' },
        { id: 'sdks-python', label: 'Python', icon: 'Python', indent: true },
        { id: 'sdks-node', label: 'Node', icon: 'NodeJS', indent: true },
        { id: 'sdks-go', label: 'Go', icon: 'Go', indent: true },
        { id: 'sdks-java', label: 'Java', icon: 'Java', indent: true },
      ],
    },
    {
      label: 'REST API',
      icon: 'Globe',
      items: [
        { id: 'rest-api', label: 'Core endpoints', icon: 'Code' },
        { id: 'rest-api-swagger', label: 'API Reference (Swagger UI)', icon: 'SwatchBook' },
        { id: 'inject', label: 'Inject API', icon: 'Syringe' },
        { id: 'try-inject', label: 'Try Inject API', icon: 'FlaskConical' },
        { id: 'prompts-pull', label: 'Prompts Pull API', icon: 'ScrollText' },
        { id: 'try-prompts-pull', label: 'Try Prompts Pull API', icon: 'FlaskConical' },
      ],
    },
    {
      label: 'MCP',
      icon: 'MCP',
      items: [
        { id: 'mcp', label: 'MCP overview', icon: 'Eye' },
        { id: 'mcp-tools', label: 'Available tools', icon: 'Wrench' },
        { id: 'mcp-setup', label: 'Setup & configuration', icon: 'Settings' },
        { id: 'mcp-usage', label: 'Usage', icon: 'Play' },
      ],
    },
    {
      label: 'A2A',
      icon: 'A2A',
      items: [
        { id: 'a2a', label: 'A2A protocol', icon: 'Cpu' },
        { id: 'a2a-skills-reference', label: 'A2A skills reference', icon: 'BookOpen' },
        { id: 'try-a2a', label: 'Try A2A', icon: 'FlaskConical' },
      ],
    },
    {
      label: 'Data Platform',
    ...
    },
    {
      ...
      icon: 'BookOpen',
      items: [
        { id: 'data-model-lineage', label: 'Data model & lineage', icon: 'GitBranch' },
        { id: 'security', label: 'Security', icon: 'Lock' },
        { id: 'contexts-agents', label: 'Contexts & agents', icon: 'Users' },
        { id: 'templates', label: 'Templates for context', icon: 'LayoutTemplate' },
        { id: 'audit-headers', label: 'Audit headers', icon: 'ClipboardList' },
      ],
    },
    {
      label: 'Enterprise',
      icon: 'Building',
      items: [
        { id: 'enterprise-readiness', label: 'Enterprise readiness', icon: 'Shield' },
        { id: 'enterprise-connection-pooling', label: 'Connection pooling', icon: 'Database' },
