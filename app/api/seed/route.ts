...
/** A2A Agent Card–style names: human-readable identity (name) and purpose (description). See A2A spec §5.5 AgentCard. */
const AGENT_NAMES: Array<{ name: string; description: string }> = [
  { name: 'Portfolio Analyst Agent', description: 'Provides portfolio analysis and performance attribution for investment and wealth management.' },
  { name: 'KYC Verification Agent', description: 'Performs know-your-customer verification and document checks for onboarding and compliance.' },
  { name: 'Loan Origination Agent', description: 'Handles loan application intake and initial underwriting support for lending workflows.' },
  { name: 'Trade Surveillance Agent', description: 'Monitors trades in real time and flags exceptions for compliance and market abuse detection.' },
  { name: 'Customer Onboarding Agent', description: 'Supports digital onboarding and identity verification for new customers.' },
  { name: 'Compliance Check Agent', description: 'Runs policy and regulatory compliance checks across processes and content.' },
  { name: 'Fraud Detection Agent', description: 'Monitors transactions and detects fraud patterns for risk and security teams.' },
  { name: 'Document Extraction Agent', description: 'Extracts and classifies data from documents for downstream systems and workflows.' },
  { name: 'Credit Scoring Agent', description: 'Provides credit risk scoring and decision support for underwriting and approvals.' },
  { name: 'AML Alert Triage Agent', description: 'Triages and escalates anti-money laundering alerts for compliance review.' },
  { name: 'Client Reporting Agent', description: 'Generates automated client reports and dashboards for advisory and custody.' },
  { name: 'Research Summarizer Agent', description: 'Summarizes research and market commentary for analysts and portfolio managers.' },
  { name: 'Suitability Advisor Agent', description: 'Assesses product suitability and risk appetite for advisory and distribution.' },
  { name: 'Settlement Reconciliation Agent', description: 'Automates settlement and reconciliation for trades and positions.' },
  { name: 'Margin Calculator Agent', description: 'Calculates margin and collateral requirements for trading and clearing.' },
  { name: 'Limit Monitor Agent', description: 'Monitors positions and limits and alerts on breaches or thresholds.' },
  { name: 'Disclosure Generator Agent', description: 'Generates regulatory and product disclosures for distribution and compliance.' },
  { name: 'Contract Analyzer Agent', description: 'Extracts terms and analyzes clauses in contracts for legal and commercial use.' },
  { name: 'Incident Triage Agent', description: 'Triages security and operations incidents and routes them for response.' },
  { name: 'Audit Sampler Agent', description: 'Supports sample selection and audit execution for internal and external audit.' },
  { name: 'Tax Classifier Agent', description: 'Classifies transactions and supports tax reporting and compliance.' },
  { name: 'Order Router Agent', description: 'Provides smart order routing and execution support for trading desks.' },
  { name: 'Client Outreach Agent', description: 'Schedules and supports client outreach and follow-up for relationship managers.' },
  { name: 'Document Reviewer Agent', description: 'Reviews documents using natural language for legal, compliance, and ops.' },
  { name: 'Model Risk Validator Agent', description: 'Supports model validation and back-testing for model risk management.' },
  { name: 'Regulatory Reporter Agent', description: 'Supports regulatory filing and reporting for supervisory and disclosure requirements.' },
  { name: 'Support Chatbot Agent', description: 'Handles customer and internal support conversations and routing.' },
  { name: 'Data Quality Monitor Agent', description: 'Runs data quality checks and anomaly detection across datasets.' },
  { name: 'Vendor Risk Scorer Agent', description: 'Assesses and monitors vendor risk for third-party and procurement.' },
  { name: 'ESG Data Aggregator Agent', description: 'Aggregates and reports ESG data for sustainability and disclosure.' },
  { name: 'Strategy Research Agent', description: 'Supports strategy and market research for planning and execution.' },
];
